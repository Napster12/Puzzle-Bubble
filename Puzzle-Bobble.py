...
class Arrow(pygame.sprite.Sprite):
    ...
    def update(self, direction):
        ...
        if direction == LEFT and self.angle < 175:
            self.angle += 2
        elif direction == RIGHT and self.angle > 5:        
            self.angle -= 2
...
def game_intro():
    ...
    while intro:
        ...
        TextSurf, TextRect = text_objects("Puzzle Bobble ", largeText)
        TextRect.center = ((640/2),(480/2))
        gameDisplay.blit(TextSurf, TextRect)

        button("New Game",150,350,100,50,green,bright_green,runGame)
...
def endScreen(score, winorlose):
    ...
    endMessage1 = endFont.render('You ' + winorlose + '! Your Score is ' + str(score) + '. Press Enter to Go Menu.', True, BLACK, BGCOLOR)
